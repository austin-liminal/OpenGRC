...
return [
    ...
    'manager' => [
        ...
        'info' => [
            'heading' => 'How to Create and Send Surveys',
            'step1_title' => 'Create a Template',
            'step1_desc' => 'Start by creating a survey template with your questions. Templates are reusable and can be used to create multiple surveys.',
            'step2_title' => 'Activate the Template',
            'step2_desc' => 'Set the template status to "Active" to make it available for creating surveys.',
            'step3_title' => 'Create a Survey',
            'step3_desc' => 'Create a survey from an active template. Add respondent details (email for external, or assign to a user for internal checklists) and set a due date.',
            'step4_title' => 'Share the Link',
            'step4_desc' => 'Copy the unique survey link and send it to your respondent. They can complete the survey without logging in.',
        ],
    ],
