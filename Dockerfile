...
# Copy your application code (including composer.json/package.json) into this build container
COPY . .

# Install Composer dependencies (including dev ones) and run initial setup
